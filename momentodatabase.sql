...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Nov-2021 às 17:52
...
--
-- Banco de dados: `momentodatabase`
--
...
(34, 'Inara', 'Ferreira', 'Cônjuge', 217),
(35, 'Gabriel', 'Ferreira', 'Filho(a)', 217),
(36, 'Rodrigo', '', 'Cônjuge', 218),
(37, 'Maya', 'Raulino', 'Filho(a)', 216),
(38, 'Laura', 'Raulino', 'Filho(a)', 216);
...
(207, 'Larissa', 'Vitória', 'larissamoura0987@gmail.com', '081.475.3341', '1997-03-21', 9, '8000.00', NULL, 6),
(208, 'Igor', 'Vinnycius', 'igorvinnycius@gmail.com', '213.876.8175', '1998-11-22', 3, '5000.00', NULL, 1),
(209, 'Emily', 'Souza', 'emilysouza@gmail.com', '342.002.1267', '1999-01-25', 3, '5000.00', NULL, 1),
(210, 'Gabriel', 'Verdani', 'gabrielverdani@gmail.com', '475.555.0321', '2005-05-10', 3, '5000.00', NULL, 1),
(211, 'Nathan', 'Oliveira', 'nathanoliveira@gmail.com', '151.226.0909', '2012-03-09', 3, '5000.00', NULL, 1),
(212, 'Rafael', 'Silva', 'rafaelsilva@gmail.com', '001.112.1100 ', '2014-11-05', 3, '5000.00', NULL, 1),
(213, 'Lucas', 'Eduardo', 'lucaseduardo@gmail.com', '181.963.5565', '2017-08-02', 3, '5000.00', NULL, 1),
(216, 'Fabiana ', 'Raulino', 'fabianaRaulino@gmail.com', NULL, '2021-05-23', 21, '6000.00', 100, 12),
(217, 'William ', 'Ferreira', 'WilliamFerreira@gmail.com', NULL, '2021-05-23', 20, '6000.00', 216, 12),
(218, 'Fernanda ', 'Lima', 'FernandaLima@gmail.com', NULL, '2021-05-23', 9, '6000.00', 216, 12);
...
(20, 'Programador', '4000.00', '20000.00'),
(21, 'Gerente de inovaçoes', '4000.00', '30000.00');
...
--
ALTER TABLE `departamento`
  MODIFY `departamento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6601;

--
-- AUTO_INCREMENT de tabela `dependentes`
--
ALTER TABLE `dependentes`
  MODIFY `dependente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de tabela `funcionarios`
--
ALTER TABLE `funcionarios`
  MODIFY `funcionario_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;

--
-- AUTO_INCREMENT de tabela `ocupacoes`
--
ALTER TABLE `ocupacoes`
  MODIFY `ocupacao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de tabela `posicao`
--
ALTER TABLE `posicao`
  MODIFY `posicao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5401;
